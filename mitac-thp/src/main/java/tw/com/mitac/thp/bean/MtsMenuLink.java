...
// Generated 2016/5/15 下午 10:51:05 by Hibernate Tools 4.3.1
...
/**
 * MtsMenuLink generated by hbm2java
 */
@Entity
@Table(name = "mts_menu_link", catalog = "thp")
public class MtsMenuLink implements java.io.Serializable {
	...
	public MtsMenuLink(String sysid, String creator, String creationDate, String operator, String operationDate,
			String menuSysid, String parentSysid) {
		this.sysid = sysid;
	...
	@Column(name = "MENU_SYSID", nullable = false, length = 45)
