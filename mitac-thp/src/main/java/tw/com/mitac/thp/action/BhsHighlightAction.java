...
/**
 * BhsHighlightAction generated by GenCode.java
 */
public class BhsHighlightAction extends DetailController<BhsHighlight> {
	private static final String PATH = ResourceBundle.getBundle("FilePathSetting").getString("bhsHighlight_pic");
