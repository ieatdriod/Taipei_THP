...
/**
 * MtsRecommandItem generated by hbm2java
 */
@Entity
@Table(name = "mts_recommand_item", catalog = "thp")
public class MtsRecommandItem implements java.io.Serializable {
	...
	public MtsRecommandItem() {
	}

	public MtsRecommandItem(String sysid, String creator, String creationDate, String operator, String operationDate,
			Integer dataOrder) {
		this.sysid = sysid;
