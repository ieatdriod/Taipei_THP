...
// Generated 2016/6/24 �U�� 04:13:01 by Hibernate Tools 4.3.1.Final
...
/**
 * MtsAppointmentFeedback generated by hbm2java
 */
@Entity
@Table(name = "mts_appointment_feedback", catalog = "thp")
public class MtsAppointmentFeedback implements java.io.Serializable {
	...
	public MtsAppointmentFeedback() {
	}

	public MtsAppointmentFeedback(String sysid, String creator, String creationDate, String operator,
			String operationDate, String parentSysid, String feedbackDetail, Date feedbackTime) {
		this.sysid = sysid;
	...
	public MtsAppointmentFeedback(String sysid, String creator, String creationDate, String operator,
			String operationDate, String remark, String parentSysid, String feedbackDetail, Date feedbackTime,
			String backMemberSysid, String memberSysid) {
		this.sysid = sysid;
		this.creator = creator;
		this.creationDate = creationDate;
		this.operator = operator;
