...
/**
 * BhsVendorProfile generated by hbm2java
 */
@Entity
@Table(name = "bhs_vendor_profile", catalog = "thp")
public class BhsVendorProfile implements java.io.Serializable {
	...
	private java.util.Set<BhsAdsC> detailSet;

	public java.util.Set<BhsAdsC> getDetailSet() {
		return detailSet;
	}

	public void setDetailSet(java.util.Set<BhsAdsC> detailSet) {
		this.detailSet = detailSet;
	}

	public BhsVendorProfile() {
	}

	public BhsVendorProfile(String sysid, String creator, String creationDate, String operator, String operationDate,
			String vendorSysid) {
		this.sysid = sysid;
	...
	public BhsVendorProfile(String sysid, String creator, String creationDate, String operator, String operationDate,
			String remark, String vendorSysid, String vendorName, String vendorVideoUrl1, String vendorVideoUrl2,
			 String vendorProfileFull, String vendorProfileSummary, String vendorHighlight,
	...
	@Column(name = "VENDOR_HIGHLIGHT", length = 50)
	public String getVendorHighlight() {
		return this.vendorHighlight;
	}
