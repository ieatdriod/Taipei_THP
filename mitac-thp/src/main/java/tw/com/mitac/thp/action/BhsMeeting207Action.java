...
public class BhsMeeting207Action extends CpsMeetingController {
	private static final String entId = "bhs";
	...
	// rules.add(new QueryRule("MeetingType", "1"));
	// rules.add(new QueryRule("creator", getUserID()));
	...
	protected Object[] jqgridList(Class<?> clazz, QueryGroup queryGroup, QueryOrder[] orders, Integer from,
		...
		queryGroup = new QueryGroup(new QueryRule("entitySysid", entSysid), new QueryRule("meetingType", "2"),
