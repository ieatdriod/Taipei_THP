...
/**
 * MtsAdsA generated by hbm2java
 */
@Entity
@Table(name = "mts_ads_a", catalog = "thp")
public class MtsAdsA implements java.io.Serializable {
	...
	public MtsAdsA(String sysid, String creator, String creationDate, String operator, String operationDate,
			Integer dataOrder, String bannerType) {
		this.sysid = sysid;
	...
	@Column(name = "BANNER_TYPE", nullable = false, length = 2)
