...
public class MtsArticleAction extends BasisCrudAction<MtsArticle> {
	 ...
	 * QueryRule("mtsArticleType", EQ, beaninfo.get("articleType")));
	 * 
	 ...
	 * QueryGroup(new QueryRule("constantId", "mtsArticleType")), new
